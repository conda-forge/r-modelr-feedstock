...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1372&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-modelr-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-modelr` can be installed with `conda`:
...
```
mamba install r-modelr
```

It is possible to list all of the versions of `r-modelr` available on your platform with `conda`:
...
```
mamba search r-modelr --channel conda-forge
```
...
mamba repoquery search r-modelr --channel conda-forge

# List packages depending on `r-modelr`:
mamba repoquery whoneeds r-modelr --channel conda-forge

# List dependencies of `r-modelr`:
mamba repoquery depends r-modelr --channel conda-forge
```
